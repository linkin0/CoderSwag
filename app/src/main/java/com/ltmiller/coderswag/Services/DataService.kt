...
object DataService {
    ...
    val hats = listOf(
        ...
        Product("Devslopses Hat Black", "$20", "hat02"),
    ...
    val hoodies = listOf(
        ...
        Product("Devslopses Hoodie Red", "$32", "hoodie02"),
        Product("Devslopes Grey Hoodie", "$28", "hoodie03"),
        Product("Devslopes Black Hoodie", "$32", "hoodie04")
    )

    val shirts = listOf(
        Product("Devslopes Shrit Black", "$18", "shirt01"),
        Product("Devslopses Badge Light Grey", "$20", "shirt02"),
